  ...
  return (
    <header className="site-header">
      <nav className="nav-pill" aria-label="Điều hướng chính">
        ...
        <div className="nav-actions"><a className="nav-signin" href="/sign-in">Đăng nhập</a><a className="nav-cta" href="/onboarding">Bắt đầu học <ArrowUpRight size={16} aria-hidden="true" /></a></div>
      ...
      {open && (
        <div id="mobile-menu" className="mobile-menu">
          ...
          <a href="/sign-in" onClick={() => setOpen(false)}>Đăng nhập</a>
          <a className="mobile-menu-cta" href="/onboarding" onClick={() => setOpen(false)}>Bắt đầu học <ArrowUpRight size={18} /></a>
        </div>
      )}
    </header>
  );
